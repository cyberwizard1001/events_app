                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      child: Center(
                        child: Text('A small description of what the app is and what it does',textAlign: TextAlign.center,style:
                          GoogleFonts.raleway(color: colors.primaryTextColor,fontSize: 17,fontWeight: FontWeight.bold),),
                      ),),
                      GradientButton(
                        onPressed: () {
                          Navigator.push(
                      ...
                      Padding(
                          ...
                          child: ElevatedButton(
                              ...
                              child: Container(
                                  constraints: const BoxConstraints(maxWidth: 300.0, minHeight: 40, maxHeight: 50),
